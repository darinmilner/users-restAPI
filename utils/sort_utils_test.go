...
func TestBubbleSortBest(t *testing.T) {
	els := []int{5, 6, 7, 8, 9}
...
func BenchmarkBuddleSort(b *testing.B) {
	els := getElements(10)
	for i := 0; i < b.N; i++ {
		BubbleSort(els)
	}
...
func BenchmarkBuddleSort1000(b *testing.B) {
...
func BenchmarkBuddleSortInt(b *testing.B) {
